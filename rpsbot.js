...
/*generates a probable action dependant on opponents reaction to own last move*/
RPS.Player.Sackbot.prototype.opponentOutcome = function(){
	var historyLength = this.moveHistory.length();
	var resultsArr = {};
	var winEvent, = {wins:0,winSum:0 winAvg:0}, lossEvent={}, tieEvent={};
	for(var i=0;i<historyLength;i++){
		if(this.moveHistory[i].result==1){
			winEvent.push({})
		}	
	};
